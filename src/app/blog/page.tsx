...
export const metadata: Metadata = {
  ...
  description:
    "Expert tips on paintless dent removal, hail damage prevention, insurance claims, and vehicle care from Confidents PDR in Douglas County, Colorado.",
};
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              ...
              weather is approaching the Douglas County area. We&apos;ll also send you
