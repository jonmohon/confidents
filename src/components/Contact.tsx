    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          {/* Left: Info */}
          <div>
            <h2 className="text-3xl sm:text-4xl font-black text-brand-dark mb-6">
              Get Your{" "}
              <span className="text-brand-orange">Free Estimate</span>
            </h2>
            <p className="text-gray-500 mb-8 leading-relaxed">
              Ready to get your vehicle looking like new? Contact us today for a
              free, no-obligation estimate. We&apos;ll come to you anywhere in
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-brand-dark mb-1">Call or Text</h3>
                  <a
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500">
                    ...
                    Colorado Springs & the entire Southwest Denver Metro area
                  </p>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-brand-dark placeholder-gray-400 focus:outline-none focus:border-brand-orange transition-colors"
                />
                <input
                  type="text"
              ...
              <input
                ...
                className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-brand-dark placeholder-gray-400 focus:outline-none focus:border-brand-orange transition-colors"
              />
              <select className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-400 focus:outline-none focus:border-brand-orange transition-colors">
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-brand-dark placeholder-gray-400 focus:outline-none focus:border-brand-orange transition-colors resize-none"
              />
              <p className="text-sm text-gray-400">
                Upload photos of the damage for a faster, more accurate estimate.
              </p>
              <button
                type="submit"
