      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl font-black text-brand-dark mb-4">
            Why Choose <span className="text-brand-orange">Confidents</span>?
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto">
            We deliver the highest quality paintless dent removal in the Denver
            Metro area with unmatched service and value.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((v) => (
            ...
            >
              <div className="w-14 h-14 bg-brand-orange/10 rounded-xl flex items-center justify-center text-brand-orange mb-5">
                {v.icon}
              </div>
